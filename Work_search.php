...
?>
	<head>
		<meta charset="UTF-8">
		<title>伸線機台管理系統 | 工作查詢</title>
        <link href="css/jquery-ui.css" rel="stylesheet">
        <link href="http://code.jquery.com/ui/1.10.4/themes/ui-lightness/jquery-ui.css" rel="stylesheet">
		<link rel="stylesheet" type="text/css" href="css/framework.css">
		<link rel="stylesheet" type="text/css" href="css/Work_search.css">
	...
	<body>		
		...
		<div id="content">
			...
			<section>
				<a href="Work_search_order.php">
					<div class="btn_work">
						<div class="btn_work_box_order"></div>
						<span>製令</span>
					</div> 
				</a>
				<a href="Work_search_machine.php">
					<div class="btn_work">
						<div class="btn_work_box_machine"></div>
						<span>機台</span>
					</div>
				</a>
				
				<br/>
				<a href="Work_search_IPistons.php"> 
					<div class="btn_work btn_work_Pistons">
						<div class="btn_work_box_IPistons"></div>
						<span>投入<br/>軸座</span>
					</div>				
				</a>
				<a href="Work_search_OPistons.php"> 
					<div class="btn_work btn_work_Pistons">
						<div class="btn_work_box_OPistons"></div>
						<span>產出<br/>軸座</span>
					</div>
				</a>
